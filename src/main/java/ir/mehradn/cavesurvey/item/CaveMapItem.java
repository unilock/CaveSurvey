...
public class CaveMapItem extends MapItem {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        if (tooltipFlag.isAdvanced()) {
            if (mapItemSavedData != null) {
                ...
                tooltipComponents.add(Component.translatable("filled_cave_map.sight_range", 1 << (sight + 4)).withStyle(ChatFormatting.GRAY));
                tooltipComponents.add(Component.translatable("filled_cave_map.sight_level", sight, 2).withStyle(ChatFormatting.GRAY));

                int scale = Math.min(mapItemSavedData.scale + (mapPostProcessing == MapPostProcessing.SCALE ? 1 : 0), 4);
                tooltipComponents.add(Component.translatable("filled_map.scale", 1 << scale).withStyle(ChatFormatting.GRAY));
                tooltipComponents.add(Component.translatable("filled_map.level", scale, 4).withStyle(ChatFormatting.GRAY));
            } else {
